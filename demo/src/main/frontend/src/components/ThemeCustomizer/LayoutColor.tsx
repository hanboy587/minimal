    ...
    return (
        <>
            ...
            <Form.Check className="form-check form-switch mb-1">
                ...
                />
                <Form.Check.Label htmlFor="vertical-layout">라이트모드</Form.Check.Label>
            </Form.Check>
            ...
            <Form.Check className="form-check form-switch mb-1">
                ...
                />
                <Form.Check.Label htmlFor="horizontal-layout">다크모드</Form.Check.Label>
            </Form.Check>
        </>
    );
};
