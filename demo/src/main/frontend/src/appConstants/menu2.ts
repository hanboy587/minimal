...
import { AUTH, ROLE_ADMIN, ROLE_USER, ROLE_WORKER } from '../utils/Auth';

export type MenuItemType2 = {
    key: string;
    label: string;
    isTitle?: boolean;
    icon?: string;
...
const MENU_ITEMS_test: MenuItemType2[] = [
    ...
    {
        key: 'base-ui-GeubyeomyeongseseoTest',
        label: '급여명세서Test', 
        isTitle: false,
        icon: 'dri dripicons-thumbs-up',
        url: '/ui/base-ui/GeubyeomyeongseseoTest',
        role: ROLE_WORKER,
    },
