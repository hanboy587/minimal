                    ...
                    <section className="py-3">
                        <Container>
                            ...
                            <Row>
                                <Col>
                                    <div className="float-start mt-3 text-black">
                                        ...
                                        <p style={{ fontSize: "16px" }}>
                                            ① 회원이 사전에 동의한 경우로 정보수집 또는 정보제공 이전에 회원에게 어떤 정보가 누구에게, 왜 필요한지, 그리고 언제까지 어떻게 보호/관리되는지 알려주고
                            ...
                            <Row>
                                <Col>
                                    <Stocks2 />
                                    <p style={{ fontSize: "19px" }} className="float-start mt-3 text-black">
                                ...
                                <Col>
                                    <div className="float-start text-black mt-3">
                                        ...
                                        <p style={{ fontSize: "19px" }}>
                                            ...
                                            <span style={{ fontSize: "16px" }}>- 개인정보를 취급하는 직원을 지정하고 담당자에게 한정시켜 최소화하여 개인정보를 관리하는 대책을 시행하고 있습니다.</span>
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                                            ② 내부관리계획의 수립 및 시행<br />
                                            <span style={{ fontSize: "16px" }}> - 개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다. </span>
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                                            ③ 개인정보의 암호화<br />
                                            <span style={{ fontSize: "16px" }}> - 회원의 개인정보인 비밀번호는 암호화되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송
                                                데이터를 암호화하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다.</span>
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                                            ④ 해킹 등에 대비한 기술적 대책<br />
                                            <span style={{ fontSize: "16px" }}> - 회사는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신∙점검을 하며
                                                외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.</span>
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                                            ⑤ 개인정보에 대한 접근 제한<br />
                                            <span style={{ fontSize: "16px" }}> - 개인정보를 처리하는 데이터베이스 시스템에 대한 접근권한의 부여, 변경, 말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며
                                                침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.</span>
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                                            ⑥ 보안을 위한 잠금장치 사용<br />
                                            <span style={{ fontSize: "16px" }}>  - 저장매체 및 보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관하고 있습니다.</span>
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                                            ⑦ 비인가자에 대한 출입 통제<br />
                                            <span style={{ fontSize: "16px" }}> - 개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.</span>
                                        </p>
                                    </div>
                                </Col>
                            </Row>
                            <Row>
                                <Col>
                                    <div className="float-start mt-3 text-black">
                                        <p style={{ fontSize: "30px" }}>
                                            10. 정보주체와 법정대리인의 권리, 의무 및 그 행사방법
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                            ...
                            <Row>
                                <Col>
                                    <div className="float-start mt-3 text-black">
                                        <p style={{ fontSize: "30px" }}>
                                            11. 개인정보 보호 책임자의 성명 또는 개인정보 보호업무 관련 고충사항을 처리하는 부서의 명칭과 전화번호 등 연락처
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                                        ...
                                        <p style={{ fontSize: "19px" }}>
                                            <strong style={{ fontSize: "22px" }}>※(참고) 개인정보 보호 유관기관</strong><br />
                                            아래는 회사와 별개의 기관으로 회사의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하거나 보다 자세한 도움이 필요하시면 문의하여 주시기 바랍니다.
                                        </p>
                                        <p style={{ fontSize: "19px" }}>
                            ...
                            <Row>
                                <Col>
                                    <div className="float-start mt-3 mb-3 text-black">
...
export default Gaeinjeongbocheoli;