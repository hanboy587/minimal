import { Row, Col, Card, Breadcrumb, Button, Form, Modal} from 'react-bootstrap';
                    ...
                    <Card>
                        ...
                        <Modal show={isOpen5} onHide={toggleQnA}>
                            ...
                            <Modal.Body className="qna">
                                <Row>
                                    <Col>
                                        <p className="mb-0 text-black font-16" style={{ fontWeight: 'bold' }}>전자세금계산서란?</p>
                                        <p className="font-15">
                                ...
                                <Row>
                                    <Col>
                                        <p className="mb-0 text-black font-16" style={{ fontWeight: 'bold' }}>전자세금계산서 발급기한</p>
                                        <p className="font-15">
                                ...
                                <Row>
                                    <Col>
                                        <p className="mb-0 text-black font-16" style={{ fontWeight: 'bold' }}>전자세금계산서 의무 발급자</p>
                                        <p className="font-15">
