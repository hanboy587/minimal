...
// 전자세금계산서 (영세율위수탁) 모바일ver


const YeongseyulwisutagM = () => {
...
const CompletelistyeongseyulwisutagM = () => {
...
const YeongseyulwisutagMpage = () => {
    return (
        <>
            ...
            <Row>
                <Col>
                    <CompletelistyeongseyulwisutagM />
                </Col>
            </Row>
        </>
    );
...
export default YeongseyulwisutagMpage;
