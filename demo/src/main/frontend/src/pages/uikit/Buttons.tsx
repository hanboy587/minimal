import { Row, Col, Card, Button, Form, Modal, DropdownButton, Dropdown } from 'react-bootstrap';
                                    ...
                                    <table className="table table-bordered table-centered mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="table-blue" style={{ width: "8%", padding: "5px" }}>종사업장번호</td>
                                                <td style={{ width: "14%", padding: "3px 3px 3px 9px" }}>
                                                    <input
                                                        id=''
                                                        name=''
