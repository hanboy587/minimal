...
import geubyeo from './geubyo.json';
...
const GeubyeoPC = () => {
    ...
    // const Geubyeo = geubyeo.map((item: any, index: any) => {
    //     return (
    //         <p key={index}>
    //             {item.item} <span>{item.pay}</span>
    //         </p>
    //     )
    // })
                                    ...
                                    <div className="chart-widget-list" >
                                        <p style={{ fontSize: "18px" }}>
                                            ...
                                            <span className="float-end">
                                                <strong style={{ color: "#0acf97" }}></strong> 원
                                            </span>
                                        </p>
                                ...
                                <Row>
                                    <Col xl={6} className="mb-3 px-3" style={{ borderRight: "0.5px solid #E0E0E0", height: "100%", padding: "15px", marginRight: "-15px" }}>
                                        <div className="chart-widget-list" >
                                            ...
                                            <div>
                                                {
                                                    geubyeopay.juhyusudang.pay != null
                                                        ? <p style={{ fontSize: "17px" }}>
                                                            {geubyeopay.juhyusudang.item}
                                                            <span className="float-end">{geubyeopay.juhyusudang.pay} 원</span>
                                                          </p>
