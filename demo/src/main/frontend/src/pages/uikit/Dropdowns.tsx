                ...
                <Col>
                    <Card>
                                                ...
                                                <div className="table-responsive mt-3 mb-0 text-center">
                                                    <table className="table table-bordered table-centered text-black" style={{ width: "100%" }}>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td rowSpan={7} className="table-madegreen">수탁사업자</td>
                                                                <td className="table-madegreen">등록번호 *</td>
                                                                <td>111-22-33344</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-madegreen">종사업장번호</td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-madegreen">상호 *</td>
                                                                <td>사업장테스트</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-madegreen">성명 *</td>
                                                                <td>나이스</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-madegreen">사업장</td>
                                                                <td>서울시 강서구 마곡동</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-madegreen">업태</td>
                                                                <td>판매</td>
                                                            </tr>
                                                            <tr>
                                                                <td className="table-madegreen">종목</td>
                                                                <td>소프트</td>
                                                            </tr>
                        ...
                        <Modal show={isOpen5} onHide={toggleQnA}>
                            ...
                            >
                                <h5 className="text-white">전자세금계산서(위수탁)</h5>
                            </Modal.Header>
                            <Modal.Body className="qna">
                                ...
                                <Row>
                                    <Col>
                                        <p className="mb-0 text-black font-16" style={{ fontWeight: 'bold' }}>위수탁 적용대상 사업장</p>
                                        <p className="font-15">
                                            제조사를 대신해서 소비자에게 제품이나 서비스를 판매했을 경우 사용됩니다
                                            위수탁 계약을 한 업체간 사용하는 전자세금계산서로 대표적인 업체로는 지마켓 옥션 쿠팡 등이 있습니다.
                                        </p>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col>
                                        <p className="mb-0 text-black font-16" style={{ fontWeight: 'bold' }}>위수탁세금계산서 발행법</p>
                                        <p className="font-15">
                                            수탁자가 전자세금계산서를 작성하고 신고합니다
                                        </p>
                                    </Col>
                                </Row>
                            </Modal.Body>
