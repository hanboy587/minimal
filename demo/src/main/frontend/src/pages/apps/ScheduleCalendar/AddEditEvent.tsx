...
const AddEditEvent = ({
    ...
    const leaveGenerateToGyeolJae = async () => {
        ...
        if(commuteRes.data.filter((item:any) => item.commuteType == '퇴근' && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL' && item.approvalStatus !='REJECTED' && item.requesterUsername == getUsername()).length != 0){
    ...
    const workGenerateToGyeolJae = async () => {
        ...
        const commuteRes = await axios.post('/gyeolJaeList');
        console.log(commuteRes.data.filter((item:any) => item.commuteType == '출근' && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL'));
        if(commuteRes.data.filter((item:any) => item.commuteType == '출근' && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL' && item.approvalStatus !='REJECTED' && item.requesterUsername == getUsername()).length != 0){
    ...
    const hyugaGenerateToGyeolJae = async () => {
        ...
        // console.log(':::::::::', data);
        const commuteRes = await axios.post('/gyeolJaeList');
        if(commuteRes.data.filter((item:any) => item.type.includes('휴가') && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL' && item.approvalStatus !='REJECTED' && item.requesterUsername == getUsername()).length != 0){
            // console.log('aaaaaaaaaaaaa ', commuteRes.data.filter((item:any) => item.type.includes('휴가') && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL' && item.approvalStatus !='REJECTED' && item.requesterUsername == getUsername()))
    ...
    const oeChulGenerateToGyeolJae = async () => {
        ...
        const commuteRes = await axios.post('/gyeolJaeList');
        if(commuteRes.data.filter((item:any) => item.type.includes('외출') && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL' && item.approvalStatus !='REJECTED' && item.requesterUsername == getUsername()).length != 0){
    ...
    const chulJangGenerateToGyeolJae = async () => {
        ...
        const commuteRes = await axios.post('/gyeolJaeList');
        if(commuteRes.data.filter((item:any) => item.type.includes('출장') && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL' && item.approvalStatus !='REJECTED' && item.requesterUsername == getUsername()).length != 0){
    ...
    const joToeGenerateToGyeolJae = async () => {
        ...
        const commuteRes = await axios.post('/gyeolJaeList');
        if(commuteRes.data.filter((item:any) => item.type.includes('조퇴') && item.nowDate == modalDate && item.approvalStatus !='APPROVED_CANCEL' && item.approvalStatus !='REJECTED' && item.requesterUsername == getUsername()).length != 0){
